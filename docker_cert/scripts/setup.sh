...
cockroach init --host=${TARGET}:26257 --certs-dir=/certs 
...
cockroach sql --url "postgresql://root@${TARGET}:26257/?sslmode=verify-full&sslrootcert=/certs/ca.crt&sslcert=/certs/client.root.crt&sslkey=/certs/client.root.key" --execute "SET CLUSTER SETTING cluster.organization = '${COCKROACH_DEV_ORGANIZATION}';"
cockroach sql --url "postgresql://root@${TARGET}:26257/?sslmode=verify-full&sslrootcert=/certs/ca.crt&sslcert=/certs/client.root.crt&sslkey=/certs/client.root.key" --execute "SET CLUSTER SETTING kv.rangefeed.enabled = true;"
